# Publishing Your Code {#publishing-your-code-ref}
...
For more information about managing an open source software project, see the book [Producing Open Source Software](https://producingoss.com/).
