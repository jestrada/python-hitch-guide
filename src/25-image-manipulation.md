...
![image](https://docs.python-guide.org/_static/photos/34575689432_3de8e9a348_k_d.jpg)
...
There are more examples of the Pillow library in the [Pillow tutorial](https://pillow.readthedocs.io/en/stable/handbook/tutorial.html).
...
There are more Python-implemented examples of OpenCV in this [collection of tutorials](https://opencv-tutorial.readthedocs.io/en/latest/).
