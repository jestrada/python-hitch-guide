# Properly Installing Python {#installation}
...
These guides go over the proper installation of `Python <which-python>`{.interpreted-text role="ref"} for development purposes, as well as setuptools, pip and virtualenv.

### Python 3 Installation Guides

- `Python 3 on MacOS <install3-osx>`{.interpreted-text role="ref"}.
- `Python 3 on Windows <install3-windows>`{.interpreted-text role="ref"}.
- `Python 3 on Linux <install3-linux>`{.interpreted-text role="ref"}.

### Legacy Python 2 Installation Guides

- `Python 2 on MacOS <install-osx>`{.interpreted-text role="ref"}.
- `Python 2 on Microsoft Windows <install-windows>`{.interpreted-text role="ref"}.
- `Python 2 on Linux <install-linux>`{.interpreted-text role="ref"}.
